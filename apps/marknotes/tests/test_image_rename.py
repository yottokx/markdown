...
import marknotes.image_rename as renames
from marknotes.assets import local_path, markdown_destinations
from marknotes.document import DocumentSession, ExternalFileChangedError
from marknotes.image_rename import (
    bulk_rename_plan,
    current_images,
    execute_rename,
    finalize_rename,
