...
class _SourceRenderer(RendererHTML):
    ...
    def _protect(self, fragment: str) -> str:
        marker = "\ue000md-editor-generated-" + uuid4().hex + "\ue001"
...
def render_markdown(source: str, *, original_source: str | None = None) -> RenderedDocument:
    ...
    if original_source is not None:
        env["selection_original"] = original_source
