...
from md_editor.interactions import EditingActions, InteractiveEditor
from md_editor.localization import install_japanese_translation
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="2ペインMarkdownエディタ")
    ...
    if args.smoke_report:
        from md_editor.smoke import start_smoke
